 ...
 */
public class Rcw5k2DaBabyAndSheeshRotateS21 implements Visualizer {
    ...
    public Rcw5k2DaBabyAndSheeshRotateS21(){
        name = "Rcw5k2 DaBaby and Sheesh Rotate S21";
    ...
    public void visualize(double timestamp, double lenght, float[] magnitudes, float[] phases) {
        ...
        for (int i = 0; i < num/2; i++) {
            ...
            daBabyImageView[i].setRotate(phases[i] * 100);
            ...
            sheeshImageView[i].setRotate(phases[i] * -100);
        }
